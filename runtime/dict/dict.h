...
int64_t TYTHON_FN(dict_get_default_by_tag)(TythonDict* d, int64_t key, int64_t default_value, int64_t key_eq_ops_handle);
...
int64_t TYTHON_FN(dict_setdefault_by_tag)(TythonDict* d, int64_t key, int64_t default_value, int64_t key_eq_ops_handle);
...
int64_t TYTHON_FN(dict_pop_default_by_tag)(TythonDict* d, int64_t key, int64_t default_value, int64_t key_eq_ops_handle);
int64_t TYTHON_FN(dict_eq)(TythonDict* a, TythonDict* b);
int64_t TYTHON_FN(dict_eq_by_tag)(TythonDict* a, TythonDict* b, int64_t key_eq_ops_handle, int64_t value_eq_ops_handle);
