...
def test_module_a() -> None:
    ...
    print('CHECK test_runner lhs:', module_a.func_a())
    print('CHECK test_runner rhs:', 1)
    assert module_a.func_a() == 1
    print(module_a.compute_a(10))
    print('CHECK test_runner lhs:', module_a.compute_a(10))
...
def test_module_b() -> None:
    ...
    print('CHECK test_runner lhs:', module_b.func_b())
    print('CHECK test_runner rhs:', 3)
    assert module_b.func_b() == 3
    print(module_b.compute_b(5))
    print('CHECK test_runner lhs:', module_b.compute_b(5))
...
def test_module_c() -> None:
    ...
    print('CHECK test_runner lhs:', module_c.func_c())
    print('CHECK test_runner rhs:', 7)
    assert module_c.func_c() == 7
    print(module_c.compute_c(5))
    print('CHECK test_runner lhs:', module_c.compute_c(5))
...
def test_module_d() -> None:
    ...
    print('CHECK test_runner lhs:', module_d.func_d())
    print('CHECK test_runner rhs:', 11)
    assert module_d.func_d() == 11
    print(module_d.compute_d(5))
    print('CHECK test_runner lhs:', module_d.compute_d(5))
...
def test_nested_bottom() -> None:
    ...
    print('CHECK test_runner lhs:', bottom.bottom_func())
    print('CHECK test_runner rhs:', 100)
    assert bottom.bottom_func() == 100
    print(bottom.bottom_compute(10))
    print('CHECK test_runner lhs:', bottom.bottom_compute(10))
...
def test_nested_mid() -> None:
    ...
    print('CHECK test_runner lhs:', mid_level.mid_func())
    print('CHECK test_runner rhs:', 110)
    assert mid_level.mid_func() == 110
    print(mid_level.mid_compute(10))
    print('CHECK test_runner lhs:', mid_level.mid_compute(10))
...
def test_nested_top() -> None:
    ...
    print('CHECK test_runner lhs:', top_level.top_func())
    print('CHECK test_runner rhs:', 111)
    assert top_level.top_func() == 111
    print(top_level.top_compute(10))
    print('CHECK test_runner lhs:', top_level.top_compute(10))
...
def test_module_e() -> None:
    ...
    print('CHECK test_runner lhs:', module_e.module_e_func())
    print('CHECK test_runner rhs:', 326)
    assert module_e.module_e_func() == 326
    print(module_e.module_e_compute(5))
    print('CHECK test_runner lhs:', module_e.module_e_compute(5))
...
def test_module_f() -> None:
    ...
    print('CHECK test_runner lhs:', module_f.module_f_func())
    print('CHECK test_runner rhs:', 327)
    assert module_f.module_f_func() == 327
    print(module_f.module_f_compute(10))
    print('CHECK test_runner lhs:', module_f.module_f_compute(10))
...
def test_module_g() -> None:
    ...
    print('CHECK test_runner lhs:', module_g.module_g_use_e())
    print('CHECK test_runner rhs:', 326)
    assert module_g.module_g_use_e() == 326
    print(module_g.module_g_compute(10))
    print('CHECK test_runner lhs:', module_g.module_g_compute(10))
...
def test_complex_imports_same_dir() -> None:
    ...
    print('CHECK test_runner lhs:', complex_imports.test_same_dir())
    print('CHECK test_runner rhs:', 100)
...
def test_complex_imports_parent() -> None:
    ...
    print('CHECK test_runner lhs:', complex_imports.test_parent_import())
    print('CHECK test_runner rhs:', 110)
...
def test_complex_imports_grandparent() -> None:
    ...
    print('CHECK test_runner lhs:', complex_imports.test_grandparent_import())
    print('CHECK test_runner rhs:', 111)
...
def test_complex_imports_great_grandparent() -> None:
    ...
    print('CHECK test_runner lhs:', complex_imports.test_great_grandparent_import())
...
def test_complex_imports_specific() -> None:
    ...
    print('CHECK test_runner lhs:', complex_imports.test_specific_imports())
...
def test_complex_imports_chain() -> None:
    ...
    print('CHECK test_runner lhs:', complex_imports.complex_chain())
...
def test_complex_imports_compute() -> None:
    ...
    print('CHECK test_runner lhs:', complex_imports.complex_compute(5))
...
def test_cross_level() -> None:
    ...
    print('CHECK test_runner lhs:', cross_level_imports.cross_level_func())
...
def test_cross_level_complex() -> None:
    ...
    print('CHECK test_runner lhs:', cross_level_imports.test_complex_imports_module())
    print('CHECK test_runner rhs:', 100)
...
def test_cross_level_sibling() -> None:
    ...
    print('CHECK test_runner lhs:', cross_level_imports.test_sibling_interaction())
...
def test_cross_level_renamed() -> None:
    ...
    print('CHECK test_runner lhs:', cross_level_imports.test_renamed_import())
    print('CHECK test_runner rhs:', 111)
...
def test_cross_level_chain() -> None:
    ...
    print('CHECK test_runner lhs:', cross_level_imports.test_deep_chain())
    print('CHECK test_runner rhs:', 321)
...
def test_cross_level_compute() -> None:
    ...
    print('CHECK test_runner lhs:', cross_level_imports.compute_cross(5))
...
def test_deepest_imports_same_dir() -> None:
    ...
    print('CHECK test_runner lhs:', deepest_imports.test_same_dir())
...
def test_deepest_imports_parent() -> None:
    ...
    print('CHECK test_runner lhs:', deepest_imports.test_parent_import())
    print('CHECK test_runner rhs:', 100)
...
def test_deepest_imports_grandparent() -> None:
    ...
    print('CHECK test_runner lhs:', deepest_imports.test_grandparent_import())
    print('CHECK test_runner rhs:', 110)
...
def test_deepest_imports_great_grandparent() -> None:
    ...
    print('CHECK test_runner lhs:', deepest_imports.test_great_grandparent_import())
    print('CHECK test_runner rhs:', 111)
...
def test_deepest_imports_five_level() -> None:
    ...
    print('CHECK test_runner lhs:', deepest_imports.test_five_level_import())
    print('CHECK test_runner rhs:', 4)
...
def test_deepest_imports_all_levels() -> None:
    ...
    print('CHECK test_runner lhs:', deepest_imports.test_all_levels())
...
def test_deepest_imports_compute() -> None:
    ...
    print('CHECK test_runner lhs:', deepest_imports.deepest_compute(5))
...
def test_module_h_deepest() -> None:
    ...
    print('CHECK test_runner lhs:', module_h.module_h_deepest())
    print('CHECK test_runner rhs:', 1325)
...
def test_import_aliases() -> None:
    print(mod_a.func_a())
    print('CHECK test_runner lhs:', mod_a.func_a())
    print('CHECK test_runner rhs:', 1)
...
def test_from_import_specific() -> None:
    print(func_a())
    print('CHECK test_runner lhs:', func_a())
    print('CHECK test_runner rhs:', 1)
    assert func_a() == 1
    print(compute_a(20))
    print('CHECK test_runner lhs:', compute_a(20))
    print('CHECK test_runner rhs:', 21)
...
def test_from_import_nested() -> None:
    print(bottom_func())
    print('CHECK test_runner lhs:', bottom_func())
    print('CHECK test_runner rhs:', 100)
    assert bottom_func() == 100
    print(bottom_compute(5))
    print('CHECK test_runner lhs:', bottom_compute(5))
    print('CHECK test_runner rhs:', 105)
...
def test_cross_module_class_construct() -> None:
    ...
    assert p.y == 4
    print(p.sum())
    print('CHECK test_runner lhs:', p.sum())
    print('CHECK test_runner rhs:', 7)
    assert p.sum() == 7
...
def test_cross_module_same_name_no_collision() -> None:
    ...
    print(a.sum())
    print('CHECK test_runner lhs:', a.sum())
    print('CHECK test_runner rhs:', 3)
    assert a.sum() == 3
    print(b.sum())
    print('CHECK test_runner lhs:', b.sum())
...
def test_from_import_nested_class() -> None:
    ...
    print('CHECK test_runner lhs:', outer.get_base())
    print('CHECK test_runner rhs:', 21)
    assert outer.get_base() == 21
    print(inner.get())
    print('CHECK test_runner lhs:', inner.get())
...
def test_from_import_deep_nested_class() -> None:
    ...
    print(leaf.triple())
    print('CHECK test_runner lhs:', leaf.triple())
    print('CHECK test_runner rhs:', 21)
