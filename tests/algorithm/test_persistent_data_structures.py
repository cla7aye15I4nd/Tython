...
def test_persistent_stack_version_branching() -> None:
    ...
    print('CHECK test_persistent_data_structures lhs:', ps.top(v1))
    print('CHECK test_persistent_data_structures rhs:', 10)
    assert ps.top(v1) == 10
    print('CHECK test_persistent_data_structures lhs:', ps.top(v2))
    print('CHECK test_persistent_data_structures rhs:', 20)
    assert ps.top(v2) == 20
    print('CHECK test_persistent_data_structures lhs:', ps.top(v3))
    ...
    print('CHECK test_persistent_data_structures rhs:', 30)
    assert x1 == 30
    print('CHECK test_persistent_data_structures lhs:', ps.top(v4))
    print('CHECK test_persistent_data_structures rhs:', 20)
    assert ps.top(v4) == 20
    print('CHECK test_persistent_data_structures lhs:', ps.top(v3))
    print('CHECK test_persistent_data_structures rhs:', 30)
    ...
    print('CHECK test_persistent_data_structures lhs:', ps.top(v5))
    ...
    print('CHECK test_persistent_data_structures rhs:', 99)
    assert p2[1] == 99
    print('CHECK test_persistent_data_structures lhs:', ps.top(p2[0]))
    print('CHECK test_persistent_data_structures rhs:', 10)
...
def test_persistent_array_many_versions() -> None:
    ...
    print('CHECK test_persistent_data_structures lhs:', pa.get(0, 0))
    print('CHECK test_persistent_data_structures rhs:', 0)
    assert pa.get(0, 0) == 0
    print('CHECK test_persistent_data_structures lhs:', pa.get(0, n - 1))
    print('CHECK test_persistent_data_structures rhs:', 0)
